          ...
          {process && process.length > 0 ? (
              process.map((p, idx) => (
                <TableRow key={idx}>
                  ...
                  <TableCell className='border border-white'>{p.ct ?? "-"}</TableCell>
                  <TableCell className='border border-white'>{p.tat ?? "-"}</TableCell>
                  <TableCell className='border border-white'>{p.wt ?? "-"}</TableCell>
                  <TableCell className='border border-white'>{p.rt ?? "-"}</TableCell>
                </TableRow>
              ))
          ) : (
            <TableRow>
                <TableCell colSpan={7} className="text-center">No processes yet</TableCell>
            </TableRow>
          )
        }
        </TableBody>
