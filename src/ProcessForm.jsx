        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="text-white flex-1 py-2 rounded-md bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:opacity-60 disabled:cursor-not-allowed"
            >
